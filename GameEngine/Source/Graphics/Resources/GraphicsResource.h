...
public:
	...
	GraphicsBox(unsigned int left, unsigned int top, unsigned int front,
...
{
	void SetData(const void* pData, unsigned int sysMemPitch = 0, unsigned int sysMemSlicePitch = 0);
};
